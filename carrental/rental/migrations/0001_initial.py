    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gearbox_types', models.CharField(choices=[('automatyczna', 'Automatyczna'), ('manualna', 'Manualna'), ('polautomatyczna', 'Polautomatyczna')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identity_document_type', models.CharField(choices=[('dowod', 'dowod osobisty'), ('paszport', 'paszport'), ('prawo_jazdy', 'prawo_jazdy')], max_length=20)),
